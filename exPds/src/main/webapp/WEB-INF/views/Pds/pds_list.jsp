...
<c:forEach var="pds" items="${list }">
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <font face="돋움" size="2" color="#000000">${pds.idx }</font></td>
				<td align="left" height="20">&nbsp;<font face="돋움" size="2"><a href="pds_hits?idx=${pds.idx }">${pds.subject }</a></font></td>
   ...
   <tr>
      <td colspan="7" align="right">
				<a href="pds_write"><img src="/resources/img/write.gif" alt="자료등록" align="middle" border="0"></a>
      &nbsp;
	  </td>
   </tr>
