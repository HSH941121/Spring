...
<!--  로그인 폼 추가 -->
  ...
  <p align="center">
  <font size="2">
  <a href="pds_modify?idx=${pds.idx }&page=${page}"><img src="/resources/img/edit-1.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="javascript:pds_del()"><img src="/resources/img/del.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="pds_list?page=${page}"><img src="/resources/img/list-2.gif" border="0"></a></font></td></tr>  
</table>  
</body>  
</html>
