...
<!--  다음에 추가할 부분 -->
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      <tr>
        ...
        <img src="/resources/img/bullet-01.gif"> <b>참 좋은 자료들</b></font></td></tr>
      <tr>
        <td colspan="7" align="right" valign="middle" height="20">
		  <font size="2" face="고딕">전체 : <b>${count }</b>건 </font>
		</td>
	  </tr>
	  <tr bgcolor="e3e9ff">
...
<c:forEach var="pds" items="${list }">
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <font face="돋움" size="2" color="#000000">${listcount}</font></td>
				<td align="left" height="20">&nbsp;<font face="돋움" size="2"><a href="pds_hits?idx=${pds.idx }&page=${page}">${pds.subject }</a></font></td>
      ...
      <tr>
	   ...
	   <tr>
         ...
         <font face="돋움" size="2" color="#000000">${listPage }</td>
		</tr>
   <tr>
      <td colspan="7" align="right">
				<a href="pds_write?page=${page}"><img src="/resources/img/write.gif" alt="자료등록" align="middle" border="0"></a>
      &nbsp;
	  </td>
   </tr>
...
<input type="hidden" name="page" value="${page}">
     <table border="0" cellspacing="0" width="100%">
      ...
      <font color="#004080" size="4" face="Courier New"><strong>Search&nbsp;</strong></font>
		...
		&nbsp;&nbsp;<a href="javascript:send()"><img src="/resources/img/search2.gif" align="middle"></a>
	   </td>
	   </tr>
    </table>
    </form>
